...
try:
    ...
    print("[Warning] Could not import 3DDFA_V2. Make sure the repository is at the expected location.")
...
class FaceModel:
    ...
    def predict(self, frame: np.ndarray, bbox: Optional[list] = None) -> Optional[Dict]:
        ...
        try:
            ...
            mesh = self._generate_mesh_from_params(params)
    ...
    def _generate_mesh_from_params(self, params: np.ndarray) -> Dict:
        """
        ...
        try:
            ...
            vertices = self.tddfa.recon_vers(params, roi_box=None, dense=True)
